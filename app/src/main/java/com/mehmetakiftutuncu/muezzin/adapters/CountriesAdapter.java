...
public class CountriesAdapter extends RecyclerView.Adapter<CountryListItemViewHolder> implements IndexedRecyclerView.Indices {
    ...
    public CountriesAdapter(List<Country> countries) {
        ...
        Collections.sort(this.countries, new Comparator<Country>() {
            ...
            public int compare(Country lhs, Country rhs) {
                return lhs.trName().compareTo(rhs.trName());
            }
        });
    ...
    public CountryListItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CountryListItemViewHolder(countryItemLayout);
    }
    ...
    private void generateMapIndex() {
        ...
        for (int i = 0, size = countries.size(); i < size; i++) {
            ...
            String key = String.valueOf(country.name().substring(0, 1));
